/**
 * StrengthOS - Complete Mobile PWA v29
 * Updates: "Apple Health" Design System, SVG Icons, Clean UI
 */
...
// --- 0. ICONS (SVG Library) ---
const Icons = {
    home: `<svg class="icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>`,
    workout: `<svg class="icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 6.5h11"></path><path d="M6.5 17.5h11"></path><path d="M6 20v-5"></path><path d="M18 20v-5"></path><path d="M6 9V4"></path><path d="M18 9V4"></path></svg>`,
    library: `<svg class="icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>`,
    guide: `<svg class="icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>`,
    settings: `<svg class="icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>`,
    refresh: `<svg class="icon-md" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>`,
    play: `<svg class="icon-md" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>`,
    heart: `<svg class="icon-md" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>`,
    fire: `<svg class="icon-md" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2c0 4-4 6-4 10a4 4 0 0 0 8 0c0-4-4-6-4-10z"></path><path d="M12 22c5.52 0 10-4.48 10-10"></path><path d="M2 12c0 5.52 4.48 10 10 10"></path></svg>`,
    check: `<svg class="icon-sm" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>`
};

// --- 1. EXERCISE LIBRARY (Same as before) ---
...
// --- COACH & LOGIC (Identical to v27, just ensuring correct export) ---
const Coach = {
    generateWeeklyFocus() {
        ...
        if (liftingSessions < freqTarget) { items.push("Consistency: You missed a target session recently. Goal: Just show up and punch the clock this week."); } 
        ...
        if (upperCount > lowerCount + 1) items.push("Balance: Lower body volume is lagging. Prioritize your next Leg Day.");
        if (lowerCount > upperCount + 1) items.push("Balance: Upper body volume is lagging. Prioritize Push/Pull next.");

        if (h.length > 0 && h.length % 18 === 0) items.push("Deload: Fatigue accumulation detected. We are lightening the load this week.");
        ...
        for (let w = 0; w < 3; w++) {
            ...
            for (let d = 0; d < 7; d++) {
                ...
                if (actual) {
                    ...
                    else if (actual.type === 'core') { status = 'core'; label = 'F'; } // F for Fire
...
const UI = {
    ...
    init() {
        ...
        // Setup Overlays
        const overlays = ['timer-overlay','readiness-modal','summary-modal','swap-modal'];
    ...
    renderDash() {
        ...
        const focus = Coach.generateWeeklyFocus()[0];
        ...
        this.container.innerHTML = `
            <div class="card focus-card">
                <div class="focus-item">
                    <div class="check-circle" onclick="this.classList.toggle('checked')"></div>
            ...
            <div class="card">
                ...
                <div class="summary-grid">
                    <div class="summary-box"><span class="summary-label">Last Upper</span><div class="summary-val clickable" onclick="UI.showSessionSummary(${lastUpIndex})">${formatDate(lastUp?.date)}</div></div>
                    <div class="summary-box"><span class="summary-label">Last Lower</span><div class="summary-val clickable" onclick="UI.showSessionSummary(${lastLowIndex})">${formatDate(lastLow?.date)}</div></div>
                </div>
                <div style="text-align:center; font-size:0.8rem; color:#8E8E93; margin-top:10px;">Total Workouts: ${count}</div>
            </div>`;
    },
    ...
    showSessionSummary(index) {
        ...
        if (s.type === 'cardio') { list.innerHTML = `<div class="session-summary-item"><strong>Cardio Session</strong><span>Completed</span></div>`; }
            ...
            list.innerHTML = s.exercises.map(ex => {
                ...
                // NEW: Detailed format: Weight x R1 x R2 x R3
                const weight = ex.sets[0]?.weight || 0;
                const repsStr = ex.sets.map(set => set.reps).join(' x ');
                return `<div class="session-summary-item"><strong>${name}</strong><span>${weight}lbs x ${repsStr}</span></div>`;
            }).join('');
        }
    ...
    renderWorkoutIntro() {
        ...
        if (draft) { this.container.innerHTML = `<div class="card"><h2 style="color:var(--warning)">Paused Session</h2><p style="color:#666">Resume your workout from ${new Date(draft.startTime).toLocaleTimeString()}?</p><button class="btn-primary" onclick="UI.resumeSession()">Resume Workout</button><button class="btn-outline" onclick="UI.clearDraft()">Discard</button></div>`; } 
    ...
    renderActiveSession(isResumeOrEdit) {
        ...
        if (isHistoryEdit) actionBtn = `<button class="btn-primary" onclick="UI.saveEditedHistory()">Save Changes</button><button class="btn-outline" onclick="UI.renderHistoryManager()">Cancel</button>`;
